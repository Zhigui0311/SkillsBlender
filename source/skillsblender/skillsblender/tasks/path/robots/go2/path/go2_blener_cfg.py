"""Unitree Go2 blender (multi-skill fusion) configuration."""

from skillsblender.tasks.path.config.blener_env_cfg import BlenerPathEnvCfg
...
class Go2BlenerEnvCfg_PLAY(Go2BlenerEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.sim.dt = 0.005
        self.decimation = 4
        self.episode_length_s = 30.0  # Longer for complex terrain
